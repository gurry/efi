// THIS WHOLE MODULE IS A COPY OF THE IO MODULE IN STDLIB
// It has been created by:
// 1. Including https://github.com/jethrogb/rust-core_io in a dummy crate and compiling
// 2. Taking the files generated during the compilation and dumping them here.
// 3. Editing them a little bit to make them compile here.
...
pub use self::util::{copy, fill_buf, sink, Sink, empty, Empty, repeat, Repeat};
