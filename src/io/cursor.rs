...
// Had to write this by hand 'cause the compiler couldn't find
// any impl of TryFrom for u64 and usize for some reason. Not enough time to investigate
#[inline]
fn to_usize(src: u64) -> io::Result<usize> {
    if src > (<usize>::max_value() as u64) {
...
fn vec_write(pos_mut: &mut u64, vec: &mut Vec<u8>, buf: &[u8]) -> io::Result<usize> {
    let pos: usize = to_usize(*pos_mut).map_err(|_| {
