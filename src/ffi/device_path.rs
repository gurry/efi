use ffi::base::{EFI_GUID, UINT8, NOT_DEFINED};
...
pub type EFI_DEVICE_PATH_UTILS_APPEND_NODE = *const NOT_DEFINED;
...
pub type EFI_DEVICE_PATH_UTILS_CREATE_NODE = *const NOT_DEFINED;
